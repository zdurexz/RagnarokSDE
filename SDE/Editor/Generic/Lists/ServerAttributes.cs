...
namespace SDE.Editor.Generic.Lists {
	...
	public sealed class ServerMobAttributes : DbAttribute {
		...
		public static readonly DbAttribute Atk1 = new ServerMobAttributes(new DbAttribute("Atk1", typeof(string), "0", "Atk (+-)20%")) { DataConverter = ValueConverters.GetSetZeroString, Description = "The minimum attack of the mob." };
		public static readonly DbAttribute Atk2 = new ServerMobAttributes(new DbAttribute("Atk2", typeof(CustomAttackProperty), "", "Matk (+-)30%")) { DataConverter = ValueConverters.GetSetZeroString, Description = "The maximum attack of the mob. If set to 0, the value will be the same as the minimum attack.", AttachedAttribute = Atk1 };
